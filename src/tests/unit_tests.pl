...
test_not_obstructed :-
    ...
    test_pass(visibility_not_obstructed(door2, door1, door4), 'Test1'),
    test_fail(visibility_not_obstructed(door2, door1, door3), 'Test2'),
    test_fail(visibility_not_obstructed(door1, door4, door2), 'Test3').
