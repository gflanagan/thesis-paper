...
Figure \ref{door-position} shows an exhibition design with doorways the same and opposing side of the gallery from the entrance.
\begin{figure}[H]
\centering
...
The spatial arrangement of display cases in galleries has been shown to influence visitors' movement patterns. Bitgood \cite{Bitgood92} showed that display cases that are located at perimeter of the gallery generate the most amount of attention, while display cases that are isolated in the middle of the room received the lowest amount of attention.
...
\begin{description}
\item[Gallery Requirement 3:] \emph{Display cases should not be isolated near the center of the room.}
\end{description} 

Circulation patterns can be disrupted when a sequence of display cases cuts horizontally across the view of a visitor as they are entering the room. This type of display pattern will cut off part of the room from the visitors normal visitation patterns by changing circulation pathways.
...
Figure \ref{cut-horizontal} shows an example gallery with two display cases examples. Figure \ref{not-cut} shows an example where the display case sequence does not cut horizontally across the visitor's view, while Figure \ref{cut} shows an example where the display cases sequence does cut horizontally.
...
The gallery floor plans for gallery rooms 226 and 238 - 244 of the Asian Wing at the Philadelphia Museum of Art and the lobby of the Museu Calouste Gulbenkian were manually built in ArchiCAD 14. The dimension and scale of the rooms where obtained from the museum to ensure as much accuracy to the real design as possible. Benches, display cases and statues were manually added to demonstrate some of the museum requirements. Figure \ref{art museum in archiCAD} shows the floor plans in ArchiCAD.
