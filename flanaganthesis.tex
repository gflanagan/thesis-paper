...
Current CAAD tools represent the physical and structural aspects of a design in a manner that is both accurate and precise. This type of representation captures the design, in terms of the precise spatial configurations as they are comprised of the architectural entities (i.e., walls, doors, windows), at a low-level of granularity that is needed in the actual construction of the building. Such a representation allows a designer to reason about the physical, structural and mechanical aspects of a design, such as the precise placement of a door in a wall or the mechanics of a window swinging open. However, this type of representation scheme does not incorporation the semantic features of the design nor the design's qualitative architectural attributes \cite{Bhatt}.

This section looks at how the DSpace reasoner represents a design in a multiple perspective manner that incorporates, (1) the semantic extension of architectural entities (artefactual extensions), (2) the spatial abstractions of the design from a qualitative spatial perspective, and (3) the physical and structural quantitative geometries of the design. The remainder of this section looks at the three segments of the DSpace representation and shows how they are formally modeled in Prolog. 

\subsection{Multiple Perspectives}
Designs are represented in DSpace with multiple perspectives. Unlike current CAAD systems that only represent the physical and structural elements of a design, DSpace represents the artefactual aspects, non-spatial extensions of an architectural entity that pertains to a specific functional quality of the entity in the context of the design. Representing the design in a multiple perspective manner allows the tools to go beyond reasoning that is purely based on the physical and structural geometries of the design.

\subsubsection{Spatial Artefacts}
Spatial artefacts are non-spatial extensions of architectural elements that pertain to a specific functional quality of the element in the context of the design. Because artefactual extensions do not have a physical manifestation, they are not represented in current CAAD tools. However, they become an important part of the design process because they effect the functionality and performance of a design. There are three types of spatial artefacts identified by Bhatt\cite{Bhatt}:
