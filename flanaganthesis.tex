...
%While the process of qualitatively reasoning about space might seem trivial from a human perspective, it is quite another story for computers. In general, space is represented numerically in computers
