...
Spatial abstractions are calculated by transformations of the quantitative geometries. Spatial transformations depends on the architectural entity type, the target spatial abstraction (point, directed point, or convex hull), and something the context of the space (direction of door into or out of a specific room). 

The following is Prolog code for the transformation rules based on the interpretation of the spatial abstraction of architectural entities in the previous section.
\begin{verbatim}
