...
The distance constraint solver solves minimum distance constraints. This solver uses the distance constraint services of the Sindalog \cite{} reasoner for distance reasoning. 
