...
The domain of architectural design is quite interesting in this respect because it depends on both aspects of space: qualitative and quantitative. In architectural design literature this distinction is commonly reffed to as \emph{form} and \emph{function}, in which the common phrase goes "\emph{form follows function}" \cite{formfunction}. In general, the context of the phrase supports the idea that the form (structure) should be determines based on its function or purpose. Now the focus here is not on the philosophy of design or an argument about the validity of such claims, but is to point out that it has been argued that these two spatial perspective are both inherent in and crucial to the success of an architectural design.
