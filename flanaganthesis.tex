...
\subsection{Privacy}
The concept of privacy in architecture implies a notion of separation and obscurity (not being visible). In the case of a room, privacy is defined as the room being separated from the main entrance of the building and having no visible doorways into the room from the main living space. Similarly, a doorway can be considered private if it is not visible from some vantage point (i.e. hidden door). The point here is that the precise definition of privacy depends on the context, i.e. a room, building, doorway. Within DSpace, the concepts of privacy has been formally defined for rooms and doorways. 

A door is private if it has the following attributes: (1) it is not visible from a central location (2) it does not mutually faces towards another door (3) it does not face towards the centroid of an adjacent room or space. A room is private if it has the following attributes: (1) it is positioned on the opposing side of the building from the main entrance (2) all doors into the room are also private per the definition above.
...
The concept of continuity in architecture describes a network of points that are mutually visible \cite{Key}. In DSpace, continuity is interpreted in the context of building navigation and wayfinding. Under this interpretation, a building, room or apartment is continuous if there is continuity between the doorways in the room, building, or apartment. 

In DSpace, continuity is defined as a network of doorways that are mutually visible to each other. The partitioning of doorways that should be continuous is based on a localized containment structure of rooms, in which doorways that are contained in the same room should maintain continuity. It would not make sense for doorways that are located on opposite sides of a building to be visible to each other, but doorways that are in the same room should be. With respect to this definition, continuity is represented as a recursive predicate in Prolog that takes a list of doorways and checks that each doorway is visible to all other doorways within the list. (need to mention doorways within a room). TBD: arguments: list of doors or room id that indicates containment level???
...
Figure \ref{continuity} shows a floor plan for a single room with 3 doors. Figure \ref{fig:continuity-con} shows a configuration of door in which each door is mutually visible to the other 2 doors. Figure \ref{fig:continuity-incon} shows a configuration of doors where the visibility between door 1 and the other two doors (2 and 3) are not visible. The visibility between door 1 and 2 is obstructed by a column. The visibility between door 1 and 3 is obstructed by a wall. The obstructing objects are in red. 
...
The concept of enclosure in architecture defines a space, as experienced from a given vantage point, as being either confined or spacious. A confined space is defined as being confined by walls or columns, while a spacious space is defined as being open. In DSpace, enclosure is defined by localized spatial structures in terms of their proximity to a given point. Under this interpretation, a room, apartment, or building can be experienced as both confined and spacious based on the location of the vantage point within the space. Such a definition takes into account that enclosure is a locally experience. For example, an alcove in an otherwise spacious room, feels confined from the perspective of being inside the alcove.

In Dspace, a space is defined as spacious if less then 2 walls or columns are close-to the vantage point. Conversely, a space is experienced as confined if two or more walls or columns are close. While this interpretation of enclosure is naive, it still maintains the notion that proximity defines the spatial structures of spaciousness and confinement in a localized environment.   
