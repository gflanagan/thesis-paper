...
The remainder of this section looks at the spatial abstraction of several architectural entities: walls, doorways, windows, columns, spaces, and interior design objects.  

The on the interpretation of the intrinsic spatial nature of specific architectural entities and how they are transformed from the quantitative geometries based on the interpretation. The following section on qualitative spatial reasoning will explain how these abstraction are used in the DSpace reasoner. 
