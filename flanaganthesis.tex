...
\begin{figure}[H]
\centering
\includegraphics[width=100mm]{multi-perspective-reps}
...
The objective of this thesis is an initial step towards building a framework that bridges the gap between a design's conceptual features to its quantitative representation (i.e., CAAD-based model). Specifically, the framework, developed in this thesis and referred to as the Conceptual Requirements Reasoner or CRR, does this in the context of conceptual requirements validation. Conceptual requirements validation involves checking that the underlying spatial structures of a design (quantitative space), is consistent with its conceptual design features as they are characterized spatially. Towards this objective the following issues have been identified as crucial:
\begin{itemize}
\item the identification, formal modeling, and spatial interpretation of architectural concepts and spatial qualities 
\item the spatial abstraction of the CAAD-based design representation, and
\item the defining of conceptual requirement to qualitative spatial design patterns 
\end{itemize}
