...
Formal qualitative calculi for topological representations such as the Region Connection Calculus \cite{Randell}, and orientational representations such as the Single Cross Calculus \cite{FreksaSC} and Oriented Point Relation Algebra \cite{Moratz}
Topology
   RCC5
Orientation
   Opra
