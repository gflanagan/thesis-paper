...
\begin{figure}[H]
 \centering
 \subfloat[operational space]{\label{operational-space}\includegraphics[width=36mm]{operational-space}}
 \hspace{9 mm}
 \subfloat[functional space]{\label{functional-space}\includegraphics[width=35mm]{functional-space}}
  \hspace{9 mm}
 \subfloat[range space]{\label{range-space}\includegraphics[width=36mm]{operational-space}}
