...
\cite{freksa1991qsr} \cite{bhattSpatialComputing}
...
\begin{table}[H]
  ...
  \end{center}
\caption{Functionality and Approach}
...
ICADS and CRR are similar with respect to the goal of supporting the design process based on high level conceptual knowledge. However, ICADS focuses more on the collaborative and knowledge based aspects of the tool, while CRR is focused on the integration of (qualitative) spatial representation and reasoning within a design reasoning context.
...
The approach used in CRR is to use an intermediate qualitative spatial layer between the high level design conceptualization and the low level geometric representation
