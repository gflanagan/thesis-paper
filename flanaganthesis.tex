...
State-of-the-art computer-aided architectural design (CAAD) programs represent architectural design at a low level of spatial abstraction.                                                             While this representation model allows CAAD programs to capture the precise spatial characteristics of a design, it means that CAAD programs lacks the underlying computational apparatus necessary to reason about design at a conceptual level.
...
A museum case study is presented to demonstrate the application of the CRR in a real world design context. It introduces a set of museum design requirements identified in research and shows how these requirements can be validated using the CRR. The results of the case study show that the CRR is an effective tool for conceptual requirements reasoning.
...
\noindent Dr. Franz Kurfess: for all the guidance during my time as a graduate student and for supporting me in completing this thesis.\\ 
...
\noindent Justin Phillips: for being a good friend and helping me finish this thesis. \\
